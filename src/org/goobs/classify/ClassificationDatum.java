...
public class ClassificationDatum<F> implements MemoryAccountable{
	//(lazy variables)
	...
	public ClassificationDatum(FeatureVector<F>[] possibleOutputs, int output) {
	...
	public <I,L> ClassificationDatum(
	...
	public boolean equals(Object o){
		if(o instanceof ClassificationDatum){
			@SuppressWarnings("rawtypes")
			ClassificationDatum<F> other = (ClassificationDatum) o;
