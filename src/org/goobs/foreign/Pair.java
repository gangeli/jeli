...
public class Pair<F, S> implements Serializable {
	...
	public static class LexicographicPairComparator<F, S> implements
		...
		public int compare(Pair<F, S> pair1, Pair<F, S> pair2) {
			int firstCompare = firstComparator.compare(pair1.getFirst(), pair2
					.getFirst());
			if (firstCompare != 0)
				return firstCompare;
			return secondComparator.compare(pair1.getSecond(), pair2
					.getSecond());
		}
	...
	/**
	 * Convenience method for construction of a <code>Pair</code> with the type
	 * inference on the arguments. So for instance we can type
	 ...
	 * @param f
	 * @param s
	 * @return <code>Pair<F,S></code> with the arguments <code>f</code> and
	 *         <code>s</code>
	 */
