...
TMP=tmp
# (classpath)
CP=${LIB}/jchart2d.jar:${LIB}/mysql.jar:${LIB}/postgresql.jar:${LIB}/scala-compiler.jar:${LIB}/scala-library.jar:${LIB}/sqlite.jar:${LIB}/scalala.jar
...
${DIST}/${DIST_DB}.jar: $(wildcard ${SRC}/org/goobs/database/*.java) ${SRC}/org/goobs/util/Utils.java ${SRC}/org/goobs/util/MetaClass.java ${SRC}/org/goobs/util/Decodable.java ${SRC}/org/goobs/io/Console.java ${SRC}/org/goobs/io/TextConsole.java
	...
	mkdir -p ${BUILD}
	mkdir -p ${DIST}
	javac -Xlint:unchecked -Xlint:deprecation -d $(BUILD) -cp $(CP) ${SRC}/org/goobs/database/*.java ${SRC}/org/goobs/util/Utils.java ${SRC}/org/goobs/util/MetaClass.java ${SRC}/org/goobs/util/Decodable.java ${SRC}/org/goobs/io/Console.java ${SRC}/org/goobs/io/TextConsole.java
